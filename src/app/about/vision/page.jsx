      ...
      <div className="container">
        ...
        <div className={styles.grid}>
          ...
          <div className={`${styles.visionText} ${styles.orderText}`}>
            <p>
              نطمح في "سند" إلى بناء منصة وطنية شاملة لتوثيق احتياجات المدارس والمراكز التعليمية في  بشكل يجعل كل حالة مرئية، كل حاجة واضحة، وكل تبرع مراقب وموثّق.
            </p>
            <p>
              نؤمن أن التعليم في  يحتاج إلى:
            </p>
            ...
            <ul className={styles.visionList}>
              ...
              <li>ربط المتبرعين خارج  باحتياجات الداخل بطريقة موثوقة ومباشرة</li>
