...
const faqData = [
  {
    ...
    answer: 'منصة سند هي منصة إنسانية تهدف إلى ربط المتبرعين بالمؤسسات التعليمية والدينية المحتاجة في سوريا، لضمان مستقبل أفضل لأجيالنا.'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer: 'بالتأكيد! إذا كنت تمثل مؤسسة تعليمية أو دينية في سوريا وتحتاج إلى دعم، يمكنك تقديم طلب توثيق عبر صفحة "طلب توثيق المؤسسة". سنقوم بمراجعة طلبك والتواصل معك.'
  },
  {
    id: 6,
