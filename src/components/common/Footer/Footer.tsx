      ...
      <div className={`${styles.container} ${styles.footerContent}`}>
        ...
        <div className={`${styles.footerSection} ${styles.footerInfo}`}>
          ...
          <Link href="/" className={styles.footerLogoContainer}>
            ...
            <Image
              ...
              width={60}
              height={46}
              className={styles.sanadlogoFooter}
            />
            {/* ✅ تم التعديل */}
            <span className={styles.logoText}>جمعية سند لدعم التعليم</span>
            {/* ✅ تم التعديل */}
          </Link>
        ...
        <div className={`${styles.footerSection} ${styles.footerLinks}`}>
          ...
          <ul>
            ...
            <li>
              <Link href="/support-staff">ادعم الكادر</Link>
            </li>
          </ul>
        </div>
        {/* ========================================================== */}
        ...
        <div className={`${styles.footerSection} ${styles.footerContact}`}>
          ...
          <p>
            <i className="fas fa-envelope"></i> info@sanadedu.org
          </p>
        </div>
        {/* ========================================================== */}
        {/* FOOTER SOCIAL MEDIA */}
